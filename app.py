...
# Commented after adding wikipedia_research
...
if prompt:
    # The course uses sequential_chain.run, but failed with:
    # ValueError: `run` not supported when there is not exactly one output key. Got ['title', 'script'].
    # delete .run fixed it.
    # Commented after adding wikipedia_research
